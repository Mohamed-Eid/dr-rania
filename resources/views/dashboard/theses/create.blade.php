        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.theses.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="supervisors" class="form-control" value="{{ old('supervisors') }}"
                                   required>
                        </div>

                        <div class="form-group">
                            <label>@lang('site.discussion_year')</label>
                            <input type="text" name="discussion_year" class="form-control" value="{{ old('discussion_year') }}"
                                   required>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <img src="{{ asset('uploads/thesis_images/default.png') }}"
