    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"></i> @lang('site.settings')</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title" style="margin-bottom: 10px;">@lang('site.settings')
                        <small>{{ $settings->total() }}</small>
                    </h3>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <a class="btn btn-info btn-sm"
                                               href="{{route('dashboard.settings.edit' , $setting->id)}}"><i
